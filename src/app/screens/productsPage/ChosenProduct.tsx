...
const actionDispatch = (dispatch: Dispatch) => ({                           //DEFINE
  saveChosenProductToStore: (data: Product) => dispatch(setChosenProduct(data)),
  saveRestaurantToStore: (data: Member) => dispatch(setRestaurant(data)),
...
export default function ChosenProduct(props: ChosenProductProps) {
  ...
  const { saveChosenProductToStore, saveRestaurantToStore } = actionDispatch(useDispatch())
  ...
  useEffect(() => {
    ...
    product
      ...
      .then((data) => saveChosenProductToStore(data))
      .catch(err => console.log(err));

    const member = new MemberService();
    member
      .getRestaurant()
      .then(data => saveRestaurantToStore(data))
      .catch((err) => console.log(err))
  }, [])
